      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            title: 'Profile & Identity',
            subtitle:
                'Name, photo, identity, bio, trusted people, preferences',
          ),
          _SettingsItem(
            icon: Icons.fingerprint_rounded,
            title: 'Fingerprint Settings Lock',
            subtitle:
                'Require fingerprint before opening settings',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Profile & Identity Data',
            subtitle:
                'Download profile, identity, preferences, contacts',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            subtitle:
                'Colors, backgrounds, dark mode, accent style',
          ),
          _SettingsItem(
            icon: Icons.wallpaper_outlined,
            title: 'Wallpapers & Backgrounds',
            subtitle:
                'Dashboard, spaces, library, onboarding, lock screens',
          ),
          _SettingsItem(
            icon: Icons.dashboard_customize_outlined,
            title: 'Dashboard Layout',
            subtitle:
                'Cards, widgets, spacing, visibility, order',
          ),
          _SettingsItem(
            icon: Icons.text_fields_rounded,
            title: 'Text & Display',
            subtitle:
                'Font size, icon softness, contrast, spacing',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Appearance Data',
            subtitle:
                'Download theme, layout, wallpaper settings',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            title: 'Manage Spaces',
            subtitle:
                'Show, hide, reorder, rename, customize every space',
          ),
          _SettingsItem(
            icon: Icons.view_carousel_outlined,
            title: 'Spaces Carousel',
            subtitle:
                'Choose active dashboard carousel spaces',
          ),
          _SettingsItem(
            icon: Icons.dashboard_outlined,
            title: 'Dashboard Space Settings',
            subtitle:
                'Home layout, widgets, daily brief, priority cards',
          ),
          _SettingsItem(
            icon: Icons.folder_copy_outlined,
            title: 'Documents Space Settings',
            subtitle:
                'Uploads, scans, folders, imports, deleted files',
          ),
          _SettingsItem(
            icon: Icons.menu_book_outlined,
            title: 'Library Space Settings',
            subtitle:
                'Bookshelf, reading dashboard, EPUBs, themes',
          ),
          _SettingsItem(
            icon: Icons.lock_outline_rounded,
            title: 'Reserve Vault Space Settings',
            subtitle:
                'Private documents, credentials, protected data',
          ),
          _SettingsItem(
            icon: Icons.password_rounded,
            title: 'Passwords Space Settings',
            subtitle:
                'Usernames, passwords, trials, account records',
          ),
          _SettingsItem(
            icon: Icons.account_balance_wallet_outlined,
            title: 'Money Space Settings',
            subtitle:
                'Bills, budgets, subscriptions, imports, income',
          ),
          _SettingsItem(
            icon: Icons.school_outlined,
            title: 'School Space Settings',
            subtitle:
                'Classes, study tools, grades, uploads, quizzes',
          ),
          _SettingsItem(
            icon: Icons.work_outline_rounded,
            title: 'Work Space Settings',
            subtitle:
                'Shifts, pay, tasks, CNA tools, work imports',
          ),
          _SettingsItem(
            icon: Icons.business_center_outlined,
            title: 'Business Space Settings',
            subtitle:
                'Salon, clients, services, models, payments',
          ),
          _SettingsItem(
            icon: Icons.spa_outlined,
            title: 'Beauty Space Settings',
            subtitle:
                'Hair, nails, looks, products, beauty planning',
          ),
          _SettingsItem(
            icon: Icons.favorite_border_rounded,
            title: 'Health Space Settings',
            subtitle:
                'Water, weight, meals, period, steps, wellness',
          ),
          _SettingsItem(
            icon: Icons.family_restroom_rounded,
            title: 'Family & Kids Space Settings',
            subtitle:
                'Kids, custody, school records, routines',
          ),
          _SettingsItem(
            icon: Icons.auto_stories_outlined,
            title: 'Spiritual Space Settings',
            subtitle:
                'Prayer, devotionals, prophecy, journal tools',
          ),
          _SettingsItem(
            icon: Icons.edit_note_rounded,
            title: 'Notes Space Settings',
            subtitle:
                'Notes, folders, deleted notes, pinned notes',
          ),
          _SettingsItem(
            icon: Icons.calendar_month_outlined,
            title: 'Calendar Space Settings',
            subtitle:
                'Main calendar, space calendars, holidays, colors',
          ),
          _SettingsItem(
            icon: Icons.flag_outlined,
            title: 'Goals Space Settings',
            subtitle:
                'Dreams, goals, vision boards, trackers',
          ),
          _SettingsItem(
            icon: Icons.check_circle_outline_rounded,
            title: 'Tasks Space Settings',
            subtitle:
                'To-dos, routines, priorities, reminders',
          ),
          _SettingsItem(
            icon: Icons.search_rounded,
            title: 'Search Space Settings',
            subtitle:
                'Universal search, filters, saved views',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Spaces Data',
            subtitle:
                'Download all space settings and space records',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            title: 'Reserve Vault',
            subtitle:
                'Secure files, private notes, sensitive records',
          ),
          _SettingsItem(
            icon: Icons.password_rounded,
            title: 'Passwords & Private Data',
            subtitle:
                'Accounts, usernames, passwords, private records',
          ),
          _SettingsItem(
            icon: Icons.visibility_off_outlined,
            title: 'Hidden Items',
            subtitle:
                'Hidden spaces, notes, folders, private screens',
          ),
          _SettingsItem(
            icon: Icons.upload_file_outlined,
            title: 'Import Vault Data',
            subtitle:
                'Import secure files, credentials, private records',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Vault Data',
            subtitle:
                'Download vault, reserve, passwords, private data',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            subtitle:
                'Swipe tutorial for the whole app',
          ),
          _SettingsItem(
            icon: Icons.menu_book_outlined,
            title: 'Tutorials by Space',
            subtitle:
                'Learn each space without cluttering dashboards',
          ),
          _SettingsItem(
            icon: Icons.replay_rounded,
            title: 'Replay Tutorials',
            subtitle:
                'Reset tips, walkthroughs, and help screens',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Tutorial Progress',
            subtitle:
                'Download guide progress and tutorial preferences',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            subtitle:
                'Tone, response style, support level, boundaries',
          ),
          _SettingsItem(
            icon: Icons.psychology_alt_outlined,
            title: 'Smart Suggestions',
            subtitle:
                'Daily tips, priorities, nudges, planning help',
          ),
          _SettingsItem(
            icon: Icons.auto_fix_high_outlined,
            title: 'Auto Organization',
            subtitle:
                'Auto-sort docs, notes, reminders, imports',
          ),
          _SettingsItem(
            icon: Icons.rule_rounded,
            title: 'Rules & Triggers',
            subtitle:
                'When this happens, Ciantis does that',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export AI & Automation Data',
            subtitle:
                'Download AI preferences, automations, rules',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            subtitle:
                'Views, colors, space calendars, holidays',
          ),
          _SettingsItem(
            icon: Icons.notifications_none_rounded,
            title: 'Notification Center',
            subtitle:
                'Alerts, badges, reminders, banners, quiet hours',
          ),
          _SettingsItem(
            icon: Icons.schedule_outlined,
            title: 'Time Zone & Daily Rhythm',
            subtitle:
                'Wake time, sleep time, focus windows',
          ),
          _SettingsItem(
            icon: Icons.sms_outlined,
            title: 'Message Templates',
            subtitle:
                'Holiday texts, client texts, sales messages',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Calendar & Notification Data',
            subtitle:
                'Download alerts, calendar preferences, templates',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            subtitle:
                'Files, photos, scans, PDFs, receipts, books',
          ),
          _SettingsItem(
            icon: Icons.document_scanner_outlined,
            title: 'Scanner Settings',
            subtitle:
                'Scan quality, auto-crop, document detection',
          ),
          _SettingsItem(
            icon: Icons.cloud_sync_outlined,
            title: 'Google Data & Sync',
            subtitle:
                'Drive, calendar, email, contacts, backup',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Everything',
            subtitle:
                'Export app data by space, topic, or date range',
          ),
        ],
      ),
      ...
      _SettingsSectionData(
        ...
        items: [
          _SettingsItem(
            ...
            title: 'Help Center',
            subtitle:
                'Setup guides, tutorials, FAQs, support',
          ),
          _SettingsItem(
            icon: Icons.info_outline_rounded,
            title: 'About Ciantis',
            subtitle:
                'Version, credits, legal, app details',
          ),
          _SettingsItem(
            icon: Icons.bug_report_outlined,
            title: 'Report a Problem',
            subtitle:
                'Send bugs, screenshots, errors, app issues',
          ),
          _SettingsItem(
            icon: Icons.developer_mode_rounded,
            title: 'Developer Options',
            subtitle:
                'Test screens, debug tools, reset sample data',
          ),
          _SettingsItem(
            icon: Icons.download_outlined,
            title: 'Export Support Data',
            subtitle:
                'Download logs, app info, support details',
          ),
        ],
      ),
    ];
                ...
                children: [
                  Center(
                    child: Text(
                      ...
                      style: TextStyle(
                        color:
                            const Color(0xFF8B7D72).withOpacity(.72),
                        fontSize: 11,
                        fontWeight: FontWeight.w300,
                        letterSpacing: 1.4,
                      ),
...
class SettingsDetailScreen extends StatefulWidget {
  ...
  @override
  State<SettingsDetailScreen> createState() =>
      _SettingsDetailScreenState();
}

class _SettingsDetailScreenState
    extends State<SettingsDetailScreen> {
  final ScrollController scrollController =
      ScrollController();
    ...
    if (index == 3) {
      _openScreen(
        const ComingSoonScreen(
          title: 'AI',
          subtitle:
              'Your assistant settings will connect here.',
          icon: Icons.auto_awesome_rounded,
        ),
      );
      return;
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color:
                  const Color(0xFFFBF8F4).withOpacity(.92),
